<?php
namespace DrestCommonTests\Response\Adapter;

use DrestCommon\Response\Response;
use DrestCommonTests\DrestCommonTestCase;
use Guzzle\Http\Message\Response as GuzzleResponse;

class GuzzleTest extends DrestCommonTestCase
{
    ...
    public static function getGuzzleAdapterResponse()
    {
        ...
        $response = Response::create($guzResponse, array('DrestCommon\\Response\\Adapter\\Guzzle'));
        return $response;
    }
...
EOT;
        ...
        $response = Response::create($guzzResponse, array('DrestCommon\\Response\\Adapter\\Guzzle'));
